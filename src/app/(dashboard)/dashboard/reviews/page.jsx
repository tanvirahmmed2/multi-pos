        ...
        <div className="flex items-center justify-between border-b border-slate-200 pb-4">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-slate-800 flex items-center gap-2">
              <BiConversation className="text-primary" />
                      ...
                      <div className="flex gap-2">
                        {rev.is_approved ? (
                          ...
                          <button
                            ...
                            disabled={isBusy}
                            className="px-3 py-1.5 text-white text-xs font-bold transition cursor-pointer flex items-center gap-1 shadow-sm disabled:opacity-50 bg-primary hover:bg-primary-dark"
                          >
