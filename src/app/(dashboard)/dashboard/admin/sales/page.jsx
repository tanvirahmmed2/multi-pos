      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 pb-4 gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Global administrative console for searching and fetching client orders by status.</p>
          </div>
          <button
            onClick={fetchOrders}
            disabled={loading}
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white p-4 border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <BiFilterAlt className="text-slate-500 text-base shrink-0" />
            <label className="text-xs font-bold text-slate-700 whitespace-nowrap">Order Status:</label>
            <select
              value={statusFilter}
              onChange={(e) => { setStatusFilter(e.target.value); setCurrentPage(1); }}
              className="px-3 py-2 bg-slate-50 border border-slate-200 text-slate-800 text-xs font-bold outline-none cursor-pointer capitalize transition"
            >
        ...
        {loading ? (
          <div className="w-full py-20 flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-slate-500 text-xs font-semibold animate-pulse">Fetching orders database...</p>
          </div>
